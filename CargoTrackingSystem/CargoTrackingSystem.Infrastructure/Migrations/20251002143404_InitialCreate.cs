        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContentValue = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Shipments_AspNetUsers_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Shipments_Customers_ReceiverCustomerId",
                        column: x => x.ReceiverCustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Shipments_Customers_SenderCustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShipmentStatusHistories_AspNetUsers_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransferStatus = table.Column<int>(type: "int", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShipmentTransfers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShipmentTransfers_Shipments_ShipmentId",
                        column: x => x.ShipmentId,
                        principalTable: "Shipments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ShipmentTransfers_Warehouses_FromWarehouseId",
                        column: x => x.FromWarehouseId,
                        principalTable: "Warehouses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ShipmentTransfers_Warehouses_ToWarehouseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shipments_ReceiverCustomerId",
                table: "Shipments",
                column: "ReceiverCustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_Shipments_SenderCustomerId",
                table: "Shipments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShipmentStatusHistories_CreatedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShipmentTransfers_FromWarehouseId",
                table: "ShipmentTransfers",
                column: "FromWarehouseId");

            migrationBuilder.CreateIndex(
                name: "IX_ShipmentTransfers_ShipmentId",
                table: "ShipmentTransfers",
                column: "ShipmentId");

            migrationBuilder.CreateIndex(
                name: "IX_ShipmentTransfers_ToWarehouseId",
                table: "ShipmentTransfers",
